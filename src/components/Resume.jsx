  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div>
          <img src="/pantex.jpg" alt="pantex" className="w-full h-[250px] rounded-2xl object-fill"/>
        ...
        <div>
          <img src="/pisd.jpg" alt="pantex" className="w-full h-[250px] rounded-2xl object-fill" />
        ...
        <div>
          <img src="/provo.png" alt="pantex" className="w-full h-[250px] rounded-2xl object-fill"/>
